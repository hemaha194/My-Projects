...
print("phrases count : ", len(doc._.phrases))
phrases1 = []
for phrase in doc._.phrases[:]:
    ...
    # # Define a regular expression pattern to extract the 'chunks' data
    # pattern = r"chunks=\[(.*?)\]"
    ...
    # if result:
    #     chunks_data = result.group(1)  # Extract the content inside the square brackets
    #     chunks_list = chunks_data.split(", ")  # Split the content into a list
    # else:
    #     chunks_list = []
        
    # print(phrase,chunks_list,len(chunks_list.split()))
    # if (len(chunks_list) > 1 ):
    #     phrases1.append(phrase)
    # # ind = str(phrase).split()
    # # chunks_str = [item for item in ind if "chunks=" in item][0]
    # # print(ind,chunks_str)
        
print("phrases count : ", len(phrases1))